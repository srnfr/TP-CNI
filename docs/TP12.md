...
Si depuis la VM (02:42:1f:d6:b7:3b/172.18.0.1) on lance un `curl` vers un Node tiers (ex 172.18.0.2:31400), on constate que c'est l'@Mac du Node (02:42:ac:12:00:05) portant le Pod du svc qui répond 
