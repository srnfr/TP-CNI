...
curl -L --remote-name-all "https://github.com/cilium/cilium-cli/releases/download/${CILIUM_CLI_VERSION}/cilium-linux-amd64.tar.gz" "https://github.com/cilium/cilium-cli/releases/download/${CILIUM_CLI_VERSION}/cilium-linux-amd64.tar.gz.sha256sum"
...
Si vous êtes directement connecté sur la VM l'alternative est :
```bash
cd /home/cilium_lab
git clone https://github.com/alexei-led/nsenter.git
./nsenter/nsenter-node.sh node-7o7xd 
```
