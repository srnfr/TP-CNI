...
Dans un autre fenêtre terminal, depuis le Pod `debug-blue` (cf [TP07](./TP07.md)), dans le namespace, tester l'acces au svc `frontend` de l'application Guestbook avec `culr` par exemple :
