...
> [!NOTE]
> En théorie (c'est à dire selon la documentation de DigitalOcean) elle devrait correspondre  à l'IP publique du visiteur, mais [l'implementation spécifique de DigitalOcean](https://docs.digitalocean.com/products/kubernetes/how-to/configure-load-balancers/#external-traffic-policies-and-health-checks) ne le permet pas et utilise une IP privée fixe affectée au LB.
>  ![DigitalOcean Load Balancer](../img/do-lb.png)
> [!NOTE]
> Or il s'avère que contrairement à la doc, DigitalOcean a activé le DSR (i.e spoofing de l'IP src) sur ses clusters kubernetes, c-a-d que les Nodes répondent au Client avec l'IP Publique du LoadBalancer.
