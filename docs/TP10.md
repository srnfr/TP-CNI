...
**NB**: Notez que Envoy utilise le moteur de regex Google RE2 qui interdit les lookaheads `(?!...)` , c-a-d les négations,  par conception, pour garantir une exécution en temps linéaire et éviter les attaques ReDoS. On ne peut donc fonctionner que par liste blanche.
