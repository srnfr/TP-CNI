...
* [But du TP](#but-du-tp)
* [Deployer l'application demo Star Wars](#deployer-l-application-demo-star-wars)
* [Activer le Policy Audit Mode pour le Endpoint DeathStar](#activer-le-policy-audit-mode-pour-le-endpoint-deathstar)
* [Créer et appliquer une NetPol laxiste](#creer-et-appliquer-une-netpol-laxiste)
* [Tester l'accès](#tester-l-acces)
* [Creer une politique ingressDeny pour bloquer l'alliance](#creer-une-politique-ingressdeny-pour-bloquer-l-alliance)
* [Tester l'accès pour l'alliance](#tester-l-acces-pour-l-alliance)
* [Cleanup](#cleanup)
