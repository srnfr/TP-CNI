...
A l'instar de cilium, existe un CLI pour Hubble (lien)[https://docs.cilium.io/en/v1.12/gettingstarted/hubble_setup/#install-the-hubble-client], mais il est déjà installé sur votre VM :
```shell
# hubble version
...
Il existe de nombreuses options de filtrage. Le détail est ici.

## Hubble Relay //TO-DO

Pour avoir des informations aggrégées de tous les noeuds, il faut s'addreser au Hubble Relay qui collecte les informations de tous les serveurs Hubble embarqués dans les cilium-agent.
