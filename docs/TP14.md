...
Vous pouvez ajouter le paramètre "-n" pour vous restreindre à un namespace.

## Jouez !!

Déployez à nouveay un TP de filtrage précdent et observez les flux bloqués ou ceux qui passent...
