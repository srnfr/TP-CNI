...
* empeche l'accès 1.1.1.1 en HTTP 
...
<ins>Indice 3 :</ins> Ne pas oublier HTTPS vers 1.1.1.1
...
Tester dans le Pod debug-blue crée dans [un précedent TP](./TP05.md#déploiement-du-pod-debug-blue-dans-le--ns-blue) :
```shell
debug-blue# curl -v http://1.1.1.1
debug-blue# curl -v -k https://1.1.1.1
...
Tous les tests doivent être OK, sauf le 1er qui doit être KO.
